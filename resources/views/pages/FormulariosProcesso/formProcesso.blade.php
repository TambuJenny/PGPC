...
<form class="mt-3" style="" method="POST" action="{{route('Processo.Create')}}">
    ...
    <div class=" card p-4 col-md-12">
        <h3><i class="fa fa-address-card"></i> <b>Processo</b> </h3>
        <hr />
        <small>Informe aqui as Informações sobre a processo</small>
        <form>
            <div class="form-group">
                <label for="exampleFormControlInput1" class="col-form-label">Tipo de crime</label>
                <select multiple class="form-control" id="exampleFormControlSelect2">
                </select>
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1" class="col-form-label">Local do Incidente</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1" class="col-form-label">Data do Incidente</label>
                <input type="date" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1" class="col-form-label">Descrição do processo</label>
                <input type="date" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1" class="col-form-label">Evidencia</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
            </div>
            <!--
                <div class="form-group">
            ...
            -->
            <div class="form-group">
                <label for="exampleFormControlTextarea1" class="col-form-label">Relatório</label>
