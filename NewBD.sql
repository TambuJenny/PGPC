...
-- A despejar estrutura para tabela pgpc.actividade
CREATE TABLE IF NOT EXISTS `actividade` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `acesso` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_pessoactividade` (`acesso`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- A despejar dados para tabela pgpc.actividade: 0 rows
...
CREATE TABLE IF NOT EXISTS `juiz` (
  ...
  `dadosPessoais` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_dados_pessoa` (`dadosPessoais`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `pessoa` (`id`, `nome`, `email`, `endereco`, `Sexo`, `data_nascimento`, `telefone`, `bi`, `created_at`, `updated_at`) VALUES
	...
	(15, 'OBRA 458', 'tambujenn855@gmail.com', 'Martires do Kifangondo Rua 17', 'masculino', '2023-05-28 00:00:00', '97463131', 'rtyuiop746', '2023-05-28 21:50:32', '2023-05-28 21:50:32'),
